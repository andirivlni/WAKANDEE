        ...
        <div class="row g-3 align-items-center">
                ...
                <form action="{{ route('catalog.index') }}" method="GET" id="searchForm">
                    <div class="search-box position-relative">
                        ...
                        <input type="text"
                               ...
                               placeholder="Cari buku, seragam, alat praktikum..."
            ...
            <div class="col-lg-6">
                <div class="d-flex flex-wrap gap-2 justify-content-lg-end">
                    <button class="btn btn-outline-secondary rounded-pill px-4 py-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#filterCanvas">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-outline-secondary rounded-pill px-3 py-2 view-toggle active" data-view="grid">
        ...
        <div class="d-flex flex-wrap align-items-center gap-2 mb-4">
            ...
            @if(request('category'))
                <span class="badge bg-light text-dark rounded-pill px-4 py-2 d-inline-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('catalog.index', array_merge(request()->except('category'), ['page' => null])) }}" class="text-decoration-none text-secondary">
                        <i class="bi bi-x"></i>
                    </a>
                </span>
            @endif
            ...
            @if(request('type'))
                <span class="badge bg-light text-dark rounded-pill px-4 py-2 d-inline-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('catalog.index', array_merge(request()->except('type'), ['page' => null])) }}" class="text-decoration-none text-secondary">
                        <i class="bi bi-x"></i>
                    </a>
                </span>
            @endif
            ...
            @if(request('condition'))
                <span class="badge bg-light text-dark rounded-pill px-4 py-2 d-inline-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('catalog.index', array_merge(request()->except('condition'), ['page' => null])) }}" class="text-decoration-none text-secondary">
                        <i class="bi bi-x"></i>
                    </a>
                </span>
            @endif
            ...
            @if(request('min_price') || request('max_price'))
                <span class="badge bg-light text-dark rounded-pill px-4 py-2 d-inline-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('catalog.index', array_merge(request()->except(['min_price', 'max_price']), ['page' => null])) }}" class="text-decoration-none text-secondary">
                        <i class="bi bi-x"></i>
                    </a>
                </span>
            @endif
            ...
            @if(request('school'))
                <span class="badge bg-light text-dark rounded-pill px-4 py-2 d-inline-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('catalog.index', array_merge(request()->except('school'), ['page' => null])) }}" class="text-decoration-none text-secondary">
                        <i class="bi bi-x"></i>
                    </a>
                </span>
            @endif
                    ...
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col-md-7 col-8">
                            <div class="d-flex flex-column h-100">
                                <div class="d-flex gap-2 mb-2">
                                    ...
                                    @endif
                                    <span class="badge bg-light text-dark rounded-pill px-3 py-1">{{ $item->category_label }}</span>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="text-md-end">
                                @if($item->type == 'sale')
                                    <span class="h5 fw-bold d-block mb-1" style="color: #667eea;">Rp {{ number_format($item->price, 0, ',', '.') }}</span>
                                    <small class="text-secondary d-block mb-2">+ admin Rp1.000</small>
                                @else
                                    <span class="h5 fw-bold text-success d-block mb-2">Gratis</span>
                                @endif
                                <a href="{{ route('catalog.show', $item->id) }}" class="btn btn-sm btn-outline-primary rounded-pill px-4">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
                ...
                <div class="row g-2">
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="min_price" class="form-control border-start-0" placeholder="0" value="{{ request('min_price') }}" min="0">
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-transparent border-end-0">Rp</span>
                            <input type="number" name="max_price" class="form-control border-start-0" placeholder="No limit" value="{{ request('max_price') }}" min="0">
                        </div>
                    </div>
                </div>
            </div>
