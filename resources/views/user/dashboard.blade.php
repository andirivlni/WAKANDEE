...
<div class="container py-4">
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card h-100 p-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="stat-icon rounded-3 d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; background: rgba(118, 75, 162, 0.1);">
            ...
            <div class="stat-card h-100 p-4">
                ...
                <div class="mt-3">
                    <span class="text-primary small">
                        <i class="bi bi-piggy-bank"></i> Hemat Rp {{ number_format($stats['total_savings'] ?? 0, 0, ',', '.') }}
                    </span>
                </div>
            </div>
        </div>
    ...
    @if(isset($pending_items) && $pending_items->count() > 0)
        <div class="alert alert-warning alert-dismissible fade show rounded-4 border-0 mb-4" style="background: rgba(255, 193, 7, 0.1); color: #856404;">
            <div class="d-flex align-items-center">
                <div class="shrink-0 me-3">
                    <i class="bi bi-exclamation-triangle-fill fs-4"></i>
                </div>
                <div class="grow">
                    <strong class="d-block mb-1">Kamu punya {{ $pending_items->count() }} barang menunggu moderasi</strong>
                    <p class="small mb-0">Admin akan memverifikasi barangmu dalam 1x24 jam. Status akan diupdate otomatis.</p>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="admin-card p-4 mb-4">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('catalog.index') }}" class="btn btn-outline-secondary rounded-pill text-start py-2">
                        <i class="bi bi-search me-2"></i>Cari Kebutuhan
                    </a>
                    <a href="{{ route('profile.edit') }}" class="btn btn-outline-secondary rounded-pill text-start py-2">
            ...
            @if(isset($pending_items) && $pending_items->count() > 0)
                <div class="admin-card p-4">
                        ...
                        @foreach($pending_items as $item)
                            <div class="d-flex align-items-center gap-3">
                                <div class="shrink-0">
                                    ...
                                    @endphp
                                    <img src="{{ $thumb }}" alt="{{ $item->name }}" width="48" height="48" style="object-fit: cover; border-radius: 12px;">
                                </div>
                                <div class="grow">
                                ...
                                <a href="{{ route('items.show', $item->id) }}" class="btn btn-sm btn-link text-decoration-none p-0" style="color: #667eea;">
                                    Detail
                                </a>
                            </div>
                        @endforeach
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('items.index') }}" class="text-decoration-none small" style="color: #667eea;">
        ...
        <div class="col-lg-8">
            ...
            <div class="admin-card p-4 mb-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('transactions.index') }}" class="text-decoration-none small" style="color: #667eea;">
                        Lihat semua <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
                                ...
                                @foreach($recent_purchases as $trx)
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                @php
                                                    $itemImages = $trx->item->images ?? [];
                                                    $itemThumb = !empty($itemImages) ? Storage::url($itemImages[0]) : asset('images/default-item.png');
                                                @endphp
                                                <img src="{{ $itemThumb }}" alt="{{ $trx->item->name }}" width="40" height="40" style="object-fit: cover; border-radius: 8px;">
                                                <div>
                                                    <p class="fw-semibold small mb-0">{{ Str::limit($trx->item->name, 20) }}</p>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-circle" style="width: 32px; height: 32px; font-size: 0.8rem; background: rgba(102,126,234,0.1); color: #667eea;">
                                        ...
                                        <td>
                                            <a href="{{ route('transactions.show', $trx->id) }}" class="btn btn-sm btn-link text-decoration-none p-0" style="color: #667eea;">
                                                Detail
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <tbody>
                                @foreach($recent_sales as $trx)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-circle" style="width: 32px; height: 32px; font-size: 0.8rem; background: rgba(118,75,162,0.1); color: #764ba2;">
